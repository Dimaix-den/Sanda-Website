export function PhilosophySection() {
  const items = [
    {
      n: '01',
      title: 'Простота снаружи, глубина внутри',
      text: 'Капитал и аналитика не мешают, а расширяют возможности',
    },
    {
      n: '02',
      title: 'Полная прозрачность расчёта',
      text: 'Видишь формулу и все её компоненты. Никакой магии.',
    },
    {
      n: '03',
      title: 'Мотивация, а не стыд',
      text: 'Стрики, мягкие цвета, без упрекающих уведомлений. Sanda твой союзник.',
    },
    {
      n: '04',
